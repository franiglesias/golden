...
> Current Status: maybe you could try, but not customization is provided nor functionality beyond very basic snapshotting.
...
```shell
go get github.com/franiglesias/golden
```
...
The first time you run the test, a snapshot file will be generated at `
__snapshots/TestSomething.snap` in the same package of the test.
