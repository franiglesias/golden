...
If you work like me, you probably will start by generating and empty object and adding different elements one at a time, running a test on each iteration to be sure how things are going. Using Golden this means using:
...
Let's see an example. Imagine that you have this function that creates a border around a title for console output. In fact, we don't need to know anything about the implementation. We should enough with its signature.
...
You can pass the following options in any of the test modes.
